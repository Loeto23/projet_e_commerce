...
namespace Jeremy\AvisBundle\Entity;
 ...
 *
 * @ORM\Table(name="avis")
 * @ORM\Entity(repositoryClass="Jeremy\AvisBundle\Repository\AvisRepository")
 */
class Avis
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Jeremy\UserBundle\Entity\User")
