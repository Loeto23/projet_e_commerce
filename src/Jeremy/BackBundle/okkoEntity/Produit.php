 ...
 * @ORM\Entity(repositoryClass="Jeremy\BackBundle\Repository\ProduitRepository")
 */
class Produit
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Jeremy\BackBundle\Entity\Panier", cascade={"persist"})
     */
    private $panier;
     ...
     * @return Produit
     */
    public function addPanier(\Jeremy\BackBundle\Entity\Panier $panier)
    {
        $this->panier[] = $panier;
     ...
     * @param \Jeremy\BackBundle\Entity\Panier $panier
     */
    public function removePanier(\Jeremy\BackBundle\Entity\Panier $panier)
    {
