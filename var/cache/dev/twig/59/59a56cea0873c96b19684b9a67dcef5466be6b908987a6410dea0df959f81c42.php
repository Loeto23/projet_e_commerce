...
class __TwigTemplate_4330c964e8b3ba106182187a32e64eddbc8168058d58ac2becd9201eb10c9821 extends Twig_Template
{
    ...
    ";
        ...
        <div id=\"tree-details-container\">
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 203
                echo "                ";
                echo $context["__internal_2f8e8e0fdf7913a1d9ca0ae084a7add9aef69a09773d77eb56d936a4ddf5dbce"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "data", array()), "forms_by_hash", array()), $this->getAttribute($context["loop"], "first", array()));
                echo "
            ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
{% macro form_tree_details(name, data, forms_by_hash, show) %}
    ...
    {% endfor %}
{% endmacro %}
", "WebProfilerBundle:Collector:form.html.twig", "C:\\wamp64\\www\\projet_e_commerce\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views/Collector/form.html.twig");
    }
}
