...
class appProdProjectContainer extends Container
{
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Jeremy\\UserBundle/Resources/views'), 'FOSUser');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'monadresse@mail.fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'monadresse@mail.fr',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'monadresse@mail.fr' => 'monadresse@mail.fr',
            ),
