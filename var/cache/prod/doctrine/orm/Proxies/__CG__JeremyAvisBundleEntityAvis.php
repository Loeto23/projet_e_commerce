...
namespace Proxies\__CG__\Jeremy\AvisBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Avis extends \Jeremy\AvisBundle\Entity\Avis implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeremy\\AvisBundle\\Entity\\Avis' . "\0" . 'id', '' . "\0" . 'Jeremy\\AvisBundle\\Entity\\Avis' . "\0" . 'commentaire', '' . "\0" . 'Jeremy\\AvisBundle\\Entity\\Avis' . "\0" . 'note', '' . "\0" . 'Jeremy\\AvisBundle\\Entity\\Avis' . "\0" . 'user', '' . "\0" . 'Jeremy\\AvisBundle\\Entity\\Avis' . "\0" . 'produit'];
        }
