...
namespace Proxies\__CG__\Jeremy\CommandeBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Commande extends \Jeremy\CommandeBundle\Entity\Commande implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeremy\\CommandeBundle\\Entity\\Commande' . "\0" . 'id', '' . "\0" . 'Jeremy\\CommandeBundle\\Entity\\Commande' . "\0" . 'dateEnregistrement', '' . "\0" . 'Jeremy\\CommandeBundle\\Entity\\Commande' . "\0" . 'prixTotal', '' . "\0" . 'Jeremy\\CommandeBundle\\Entity\\Commande' . "\0" . 'user'];
        }
