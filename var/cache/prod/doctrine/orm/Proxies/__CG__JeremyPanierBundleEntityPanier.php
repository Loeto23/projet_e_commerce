...
namespace Proxies\__CG__\Jeremy\PanierBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Panier extends \Jeremy\PanierBundle\Entity\Panier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeremy\\PanierBundle\\Entity\\Panier' . "\0" . 'id', '' . "\0" . 'Jeremy\\PanierBundle\\Entity\\Panier' . "\0" . 'quantite', '' . "\0" . 'Jeremy\\PanierBundle\\Entity\\Panier' . "\0" . 'prix', '' . "\0" . 'Jeremy\\PanierBundle\\Entity\\Panier' . "\0" . 'commande'];
        }
