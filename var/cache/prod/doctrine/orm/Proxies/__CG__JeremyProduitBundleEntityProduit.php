...
namespace Proxies\__CG__\Jeremy\ProduitBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Produit extends \Jeremy\ProduitBundle\Entity\Produit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeremy\\ProduitBundle\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'Jeremy\\ProduitBundle\\Entity\\Produit' . "\0" . 'reference', '' . "\0" . 'Jeremy\\ProduitBundle\\Entity\\Produit' . "\0" . 'categorie', '' . "\0" . 'Jeremy\\ProduitBundle\\Entity\\Produit' . "\0" . 'titre', '' . "\0" . 'Jeremy\\ProduitBundle\\Entity\\Produit' . "\0" . 'description', '' . "\0" . 'Jeremy\\ProduitBundle\\Entity\\Produit' . "\0" . 'couleur', '' . "\0" . 'Jeremy\\ProduitBundle\\Entity\\Produit' . "\0" . 'taille', '' . "\0" . 'Jeremy\\ProduitBundle\\Entity\\Produit' . "\0" . 'photo', '' . "\0" . 'Jeremy\\ProduitBundle\\Entity\\Produit' . "\0" . 'prix', '' . "\0" . 'Jeremy\\ProduitBundle\\Entity\\Produit' . "\0" . 'stock', '' . "\0" . 'Jeremy\\ProduitBundle\\Entity\\Produit' . "\0" . 'panier'];
        }
