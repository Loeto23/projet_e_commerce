...
namespace Proxies\__CG__\Jeremy\ReductionBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Reduction extends \Jeremy\ReductionBundle\Entity\Reduction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeremy\\ReductionBundle\\Entity\\Reduction' . "\0" . 'id', '' . "\0" . 'Jeremy\\ReductionBundle\\Entity\\Reduction' . "\0" . 'code', '' . "\0" . 'Jeremy\\ReductionBundle\\Entity\\Reduction' . "\0" . 'montant', '' . "\0" . 'Jeremy\\ReductionBundle\\Entity\\Reduction' . "\0" . 'panier'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Reduction $proxy) {
